...
use SMBBundle\SMB\Exception\AccessDeniedException;
use SMBBundle\SMB\Exception\AlreadyExistsException;
use SMBBundle\SMB\Exception\Exception;
use SMBBundle\SMB\Exception\FileInUseException;
...
class Parser {
	/**
	 * @var \SMBBundle\SMB\TimeZoneProvider
	 */
	protected $timeZoneProvider;

	/**
	 * @param \SMBBundle\SMB\TimeZoneProvider $timeZoneProvider
	 */
