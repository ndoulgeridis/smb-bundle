...
use SMBBundle\SMB\Exception\AlreadyExistsException;
use SMBBundle\SMB\Exception\ConnectionRefusedException;
use SMBBundle\SMB\Exception\Exception;
use SMBBundle\SMB\Exception\ForbiddenException;
use SMBBundle\SMB\Exception\HostDownException;
use SMBBundle\SMB\Exception\InvalidTypeException;
use SMBBundle\SMB\Exception\NoRouteToHostException;
use SMBBundle\SMB\Exception\NotEmptyException;
use SMBBundle\SMB\Exception\NotFoundException;
use SMBBundle\SMB\Exception\TimedOutException;
